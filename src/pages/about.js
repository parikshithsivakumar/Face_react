...
const AboutUsPage = () => {
  const teamMembers = [
    {
      name: 'Anirudh',
      role: 'President',
      researchInterests: ['Image Processing', 'Machine Learning', 'Deep Learning', 'Remote Sensing', 'Computer Vision', 'Virtual Reality', 'Artificial Reality'],
  ...
  return (
    <div className='back'>
      <Aboutclub/>
      <h1 style={{ fontSize: '2rem', margin: '4rem' , color: '#5aefe7' }}>Meet Our Executive Team</h1>
